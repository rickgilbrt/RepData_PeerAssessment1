...
urlSource <- "https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2Factivity.zip"
...
be some rationale underling the value(s) chosen.  The number of missing 
...
assumption.  Extend that logic to a string of 4 or 5 missing values and that
...
missing interval is like the average of the same interval over all days, without regard for 
